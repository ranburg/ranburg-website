...
const RAW_TOPICS: RawTopic[] = [
  ...
  ["percentage-calculator-online-guide", "Percentage Calculator: How to Find X% of a Number Fast", "percentage calculator online", ["percentage-calculator", "percentage-change-calculator"], "calculators", "Everyday Math"],
  ["percentage-increase-decrease-guide", "Percentage Increase vs Decrease: Formula With Examples", "percentage increase calculator", ["percentage-change-calculator", "percentage-calculator"], "calculators", "Everyday Math"],
  ["bmi-calculator-who-categories", "BMI Calculator: What the Number Means (WHO Categories)", "bmi calculator online", ["bmi-calculator", "age-calculator"], "calculators", "Everyday Math"],
  ["cagr-calculator-mutual-funds", "CAGR Calculator for Mutual Funds and Stocks", "cagr calculator", ["cagr-calculator", "sip", "fd-calculator"], "calculators", "India Investing"],
  ["fd-calculator-india-maturity", "FD Calculator India: Estimate Fixed Deposit Maturity", "fd calculator india", ["fd-calculator", "simple-interest-calculator", "sip"], "calculators", "India Investing"],
  ["unix-timestamp-epoch-converter", "Unix Timestamp Converter: Epoch to Date and Back", "unix timestamp converter", ["unix-timestamp-converter", "working-days-calculator"], "development", "Developer Tools"],
  ["utm-builder-google-analytics", "UTM Builder: Tag Campaign Links for Google Analytics", "utm builder", ["utm-builder", "qr-generator", "meta-tag-generator"], "digital-marketing", "Digital Marketing"],
  ["working-days-calculator-hr", "Working Days Calculator: Count Business Days Between Dates", "working days calculator", ["working-days-calculator", "hours-calculator"], "calculators", "Everyday Math"],
  ["number-to-words-indian-rupees", "Number to Words Converter for Indian Rupees (Lakh & Crore)", "number to words indian", ["number-to-words", "invoice-generator"], "calculators", "Everyday Math"],
  ["keyword-density-checker-guide", "Keyword Density Checker: Ideal Percentage for SEO Copy", "keyword density checker", ["keyword-density-checker", "readability-checker", "word-counter"], "seo", "SEO Tools"],
  ["schema-markup-generator-guide", "Schema Markup Generator: FAQ and HowTo JSON-LD", "schema markup generator", ["schema-markup-generator", "meta-tag-generator"], "seo", "SEO Tools"],
  ["heic-to-jpg-how-to", "How to Convert HEIC to JPG Online (iPhone Photos, No App)", "how to convert heic to jpg", ["heic-to-jpg", "image-compressor"], "creators", "Media Utilities"],
  ["discount-calculator-sale-price", "Discount Calculator: Sale Price and Amount Saved", "discount calculator", ["discount-calculator", "percentage-calculator"], "calculators", "Everyday Math"],
  ["rd-calculator-india-guide", "RD Calculator India: Recurring Deposit Maturity Formula", "rd calculator india", ["rd-calculator", "fd-calculator", "sip"], "calculators", "India Investing"],
  ["inflation-calculator-purchasing-power", "Inflation Calculator: Future Cost of Money", "inflation calculator", ["inflation-calculator", "cagr-calculator"], "calculators", "India Investing"],
  ["calorie-calculator-bmr-tdee", "Calorie Calculator: BMR and TDEE With Mifflin-St Jeor", "calorie calculator", ["calorie-calculator", "bmi-calculator"], "calculators", "Everyday Math"],
  ["password-strength-checker-guide", "Password Strength Checker: What Makes a Password Strong", "password strength checker", ["password-strength-checker", "password-generator"], "development", "Developer Tools"],
  ["days-between-two-dates-guide", "How Many Days Between Two Dates? Date Difference Calculator", "days between dates", ["date-difference-calculator", "working-days-calculator"], "calculators", "Everyday Math"],
  ["roman-numeral-converter-guide", "Roman Numeral Converter: 1 to 3999 With Examples", "roman numeral converter", ["roman-numeral-converter", "number-to-words"], "generators", "Online Generators"],
  ["text-to-binary-converter-guide", "Text to Binary Converter: Encode and Decode Instantly", "text to binary", ["text-to-binary", "html-encoder"], "development", "Developer Tools"],
  ["tip-calculator-split-bill", "Tip Calculator: Split a Bill With Gratuity", "tip calculator", ["tip-calculator", "bill-split-calculator"], "calculators", "Everyday Math"],
  ["average-calculator-mean", "Average Calculator: Mean of a List of Numbers", "average calculator", ["average-calculator", "percentage-calculator"], "calculators", "Everyday Math"],
  ["px-to-rem-css-guide", "PX to REM Converter for CSS Root Font Size", "px to rem converter", ["px-to-rem-converter", "color-converter"], "development", "Developer Tools"],
  ["water-intake-calculator-guide", "Water Intake Calculator: How Much Water to Drink by Weight", "water intake calculator", ["water-intake-calculator", "calorie-calculator"], "calculators", "Everyday Math"],
];
