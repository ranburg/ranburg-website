...
export const TOOLS_CONFIG: ToolConfig[] = [
  ...
  },
  {
    ...
    howToUse: [
      ...
      "Enter the amount and select GST rate (5%, 12%, 18%, or 28%).",
      "View net amount, GST amount, and gross total.",
      "Use CGST/SGST split for intra-state transactions.",
    ],
    formula: "Exclusive: GST = amount × rate/100, gross = amount + GST. Inclusive: net = amount / (1 + rate/100), GST = amount − net.",
    faq: [
