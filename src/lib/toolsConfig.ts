...
export const TOOLS_CONFIG: ToolConfig[] = [
  ...
  },
  {
    ...
    shortDescription:
      "Model systematic withdrawals with inflation, multiple LIC maturity top-ups, and PF balance for real-world retirement income planning.",
    category: "financial",
    icon: "Wallet",
    ...
    popular: true,
    seo: {
      title: "SWP Calculator Online Free — LIC Maturity & PF Retirement Planner | Ranburg",
      description:
        "Free SWP calculator with inflation adjustment, multiple LIC policy maturity top-ups, and PF balance. Plan systematic withdrawal income for retirement in India — no signup.",
      keywords: [
        "SWP calculator",
        "systematic withdrawal plan calculator",
        "SWP calculator india",
        "retirement SWP calculator",
        "SWP with LIC maturity",
        "SWP PF calculator",
    ...
    howToUse: [
      "Enter your mutual fund SWP corpus and monthly withdrawal.",
      "Optionally add current PF balance (now or on a future access date).",
      "Add one or more LIC policies with plan name, dates, and estimated maturity amount.",
      "Set expected return, years, and inflation options.",
      "Review corpus top-ups when LIC matures and how long withdrawals last.",
    ],
    formula:
      "Each month: Balance = Balance × (1 + r) − Withdrawal; add LIC maturity and PF access lump sums in the month they occur. PV = FV / (1 + i)^n.",
    faq: [
      { question: "What is an SWP?", answer: "A Systematic Withdrawal Plan lets you withdraw a fixed amount regularly from investments while the remainder continues to grow." },
      { question: "Can I include LIC policies?", answer: "Yes. Add multiple policies with maturity dates and estimated maturity amounts. When a policy matures during the SWP horizon, that amount is added to the corpus." },
      { question: "How does PF work here?", answer: "Add your current PF balance and either fold it into the SWP corpus immediately or schedule it for a future access date while it grows at a PF-like rate." },
      { question: "Is maturity amount from LIC live?", answer: "No. Estimate with our LIC maturity calculator or your bonus statement, then paste the amount into SWP." },
      { question: "Why show purchasing power?", answer: "Nominal rupees in future years buy less due to inflation. Present value shows today’s purchasing power." },
    ],
  },
  {
    slug: "emi",
