...
export const TOOL_SEO_CATEGORY_MAP: Record<string, SeoCategorySlug[]> = {
  ...
  "instagram-revenue-calculator": ["calculators", "business", "seo"],
  "adsense-revenue-calculator": ["calculators", "business", "seo"],
  ...
  "cagr-calculator": ["calculators", "business"],
  "fd-calculator": ["calculators", "business"],
  "simple-interest-calculator": ["calculators"],
  "vat-calculator": ["calculators", "business"],
  "unix-timestamp-converter": ["developer"],
  "utm-builder": ["seo", "generators"],
  "sha256-hash-generator": ["developer"],
  "color-converter": ["developer", "generators"],
  "working-days-calculator": ["calculators", "business"],
  "number-to-words": ["calculators", "business"],
  "html-encoder": ["developer"],
  "aspect-ratio-calculator": ["image", "social-media"],
  "duplicate-line-remover": ["text", "seo"],
  "find-and-replace": ["text"],
  "hours-calculator": ["calculators"],
  "readability-checker": ["seo", "text"],
  "random-number-generator": ["generators", "developer"],
  "discount-calculator": ["calculators"],
  "rd-calculator": ["calculators", "business"],
  "inflation-calculator": ["calculators"],
  "calorie-calculator": ["calculators"],
  "password-strength-checker": ["developer", "generators"],
  "date-difference-calculator": ["calculators"],
  "roman-numeral-converter": ["generators"],
  "text-to-binary": ["developer", "text"],
  "tip-calculator": ["calculators"],
  "average-calculator": ["calculators"],
  "px-to-rem-converter": ["developer"],
