...
export const PERSONAS: Persona[] = [
  ...
  },
  {
    ...
    theme: {
      accent: "#0D9B8A",
      accentSoft: "#2EE6C8",
      accentEmerald: "#0B1220",
      tintFrom: "rgba(13, 155, 138, 0.08)",
      tintTo: "rgba(11, 18, 32, 0.04)",
      tintFromDark: "rgba(46, 230, 200, 0.12)",
      tintToDark: "rgba(46, 230, 200, 0.04)",
      heroGradient: "from-[#0D9B8A]/20 via-[#0B1220]/10 to-transparent",
      fontHint: "sans",
    },
    featuredToolIds: [
      "invoice-generator",
