        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 sm:px-6 lg:px-8">
          ...
          <div className="hidden items-center gap-1 md:flex">
            ...
            <Link
              ...
              className={cn(
                "relative rounded-lg px-4 py-2 text-sm font-medium transition-colors",
                pathname === "/contact" ? "text-white" : "text-slate-400 hover:text-white"
              )}
            >
              Contact
              {pathname === "/contact" && (
          ...
          <div className="hidden items-center gap-3 md:flex">
            <Link
              href="/contact"
              className="rounded-xl bg-gradient-to-r from-accent to-blue-600 px-5 py-2.5 text-sm font-semibold text-white shadow-glow transition-all hover:scale-[1.02] hover:shadow-[0_0_50px_rgba(59,130,246,0.4)] active:scale-[0.98]"
            >
        ...
        <AnimatePresence>
          {mobileOpen && (
            <motion.div
              ...
              className="max-h-[80vh] overflow-y-auto border-t border-white/[0.06] md:hidden"
            >
              <div className="flex flex-col gap-1 px-4 py-4">
                ...
                <button
                  ...
                  className={cn(
                    ...
                    isToolsActive ? "bg-white/[0.06] text-white" : "text-slate-400"
                  )}
                >
                  Tools
                ...
                {mobileToolsOpen && (
                  <div className="ml-2 space-y-4 border-l border-white/[0.06] pl-4">
                        ...
                        {TOOLS_CONFIG.filter((t) => t.category === cat.id).map((tool) => {
                          ...
                          return (
                            <Link
                              ...
                              onClick={() => setMobileOpen(false)}
                              className="flex items-center gap-2 rounded-lg px-3 py-2 text-sm text-slate-400 hover:text-white"
                            >
                ...
                <Link
                  href="/contact"
                  onClick={() => setMobileOpen(false)}
                  className="mt-2 rounded-xl bg-gradient-to-r from-accent to-blue-600 px-4 py-3 text-center text-sm font-semibold text-white"
                >
                  Get a Free Consultation
                </Link>
              </div>
