          ...
          >
            <div className="dropdown-panel overflow-hidden rounded-2xl">
              <div className="grid grid-cols-3 gap-0">
                {TOOL_CATEGORIES.map((category) => {
                  ...
                  return (
                    <div
                      key={category.id}
                      className="border-b border-r border-theme-subtle p-4 last:border-r-0"
                    >
              ...
              <Link
                href="/tools"
                onClick={() => setOpen(false)}
                className="flex items-center justify-center gap-2 border-t border-theme-subtle bg-slate-50 px-4 py-3 text-sm font-medium text-accent transition-colors hover:bg-slate-100 dark:bg-slate-900/50 dark:hover:bg-slate-800/80"
              >
