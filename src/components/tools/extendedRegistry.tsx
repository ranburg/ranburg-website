...
export const EXTENDED_TOOL_COMPONENTS: Record<string, ComponentType> = {
  ...
  "percentage-calculator": lazy(() => import("./DemandTools").then((m) => ({ default: m.PercentageCalculatorTool }))),
  "percentage-change-calculator": lazy(() => import("./DemandTools").then((m) => ({ default: m.PercentageChangeTool }))),
  "bmi-calculator": lazy(() => import("./DemandTools").then((m) => ({ default: m.BmiCalculatorTool }))),
  "cagr-calculator": lazy(() => import("./DemandTools").then((m) => ({ default: m.CagrCalculatorTool }))),
  "fd-calculator": lazy(() => import("./DemandTools").then((m) => ({ default: m.FdCalculatorTool }))),
  "simple-interest-calculator": lazy(() => import("./DemandTools").then((m) => ({ default: m.SimpleInterestTool }))),
  "vat-calculator": lazy(() => import("./DemandTools").then((m) => ({ default: m.VatCalculatorTool }))),
  "unix-timestamp-converter": lazy(() => import("./DemandTools").then((m) => ({ default: m.UnixTimestampTool }))),
  "utm-builder": lazy(() => import("./DemandTools").then((m) => ({ default: m.UtmBuilderTool }))),
  "sha256-hash-generator": lazy(() => import("./DemandTools").then((m) => ({ default: m.Sha256Tool }))),
  "color-converter": lazy(() => import("./DemandTools").then((m) => ({ default: m.ColorConverterTool }))),
  "working-days-calculator": lazy(() => import("./DemandTools").then((m) => ({ default: m.WorkingDaysTool }))),
  "number-to-words": lazy(() => import("./DemandTools").then((m) => ({ default: m.NumberToWordsTool }))),
  "html-encoder": lazy(() => import("./DemandTools").then((m) => ({ default: m.HtmlEncoderTool }))),
  "aspect-ratio-calculator": lazy(() => import("./DemandTools").then((m) => ({ default: m.AspectRatioTool }))),
  "duplicate-line-remover": lazy(() => import("./DemandTools").then((m) => ({ default: m.DuplicateLineRemoverTool }))),
  "find-and-replace": lazy(() => import("./DemandTools").then((m) => ({ default: m.FindReplaceTool }))),
  "hours-calculator": lazy(() => import("./DemandTools").then((m) => ({ default: m.HoursCalculatorTool }))),
  "readability-checker": lazy(() => import("./DemandTools").then((m) => ({ default: m.ReadabilityCheckerTool }))),
  "random-number-generator": lazy(() => import("./DemandTools").then((m) => ({ default: m.RandomNumberTool }))),
  "discount-calculator": lazy(() => import("./DemandTools").then((m) => ({ default: m.DiscountCalculatorTool }))),
  "rd-calculator": lazy(() => import("./DemandTools").then((m) => ({ default: m.RdCalculatorTool }))),
  "inflation-calculator": lazy(() => import("./DemandTools").then((m) => ({ default: m.InflationCalculatorTool }))),
  "calorie-calculator": lazy(() => import("./DemandTools").then((m) => ({ default: m.CalorieCalculatorTool }))),
  "password-strength-checker": lazy(() => import("./DemandTools").then((m) => ({ default: m.PasswordStrengthTool }))),
  "date-difference-calculator": lazy(() => import("./DemandTools").then((m) => ({ default: m.DateDifferenceTool }))),
  "roman-numeral-converter": lazy(() => import("./DemandTools").then((m) => ({ default: m.RomanNumeralTool }))),
  "text-to-binary": lazy(() => import("./DemandTools").then((m) => ({ default: m.TextToBinaryTool }))),
  "tip-calculator": lazy(() => import("./DemandTools").then((m) => ({ default: m.TipCalculatorTool }))),
  "average-calculator": lazy(() => import("./DemandTools").then((m) => ({ default: m.AverageCalculatorTool }))),
  "px-to-rem-converter": lazy(() => import("./DemandTools").then((m) => ({ default: m.PxToRemTool }))),
  "water-intake-calculator": lazy(() => import("./DemandTools").then((m) => ({ default: m.WaterIntakeTool }))),
};
