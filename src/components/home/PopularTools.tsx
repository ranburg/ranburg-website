...
const displaySlugs = POPULAR_TOOL_SLUGS.filter((s) => !HERO_TOOL_SLUGS.includes(s)).slice(0, 6);
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mb-10 text-center">
          <h2 className="text-3xl font-bold text-theme-heading sm:text-4xl">
            More Free <span className="text-gradient-accent">Tools</span>
          </h2>
          <p className="mx-auto mt-3 max-w-xl text-theme-muted">
            Calculators, formatters, generators, and developer utilities beyond social analytics.
          </p>
        </div>
